...
<style>
  ...
  body { font-family: 'Noto Sans Khmer', Arial, sans-serif; color: #111; }
  .print-actions { display:flex; justify-content:flex-end; gap:10px; margin: 0 auto 12px; width: 1280px; }
  .print-actions button { border:0; background:#111827; color:#fff; padding:10px 16px; border-radius:10px; font:600 14px 'Noto Sans Khmer',sans-serif; cursor:pointer; }
